...
**MANDATORY:** Use the musician skill launch prompt template for each session. See `references/musician-launch-prompt-template.md` for the complete template and fill-in instructions.
