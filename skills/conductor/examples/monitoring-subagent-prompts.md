...
<context>
**Note (v5.0):** This example predates the universality update. References to "kitty windows" should be read as "Musician sessions" — session management now uses the session layer (references/session-layer.md).
</context>
